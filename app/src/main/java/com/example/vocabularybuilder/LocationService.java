...
/**
 * reference: https://www.jianshu.com/p/63846d0d22cf
 */
...
public class LocationService {
    ...
    public void unregisteNotifyrListener(BDNotifyListener listener){
        if(listener != null){
    ...
    public void setNotifyLocation(BDNotifyListener notifyListener,float la,float lo){
            notifyListener.SetNotifyLocation(la,lo,1000,this.getClient().getLocOption().getCoorType());
    }
